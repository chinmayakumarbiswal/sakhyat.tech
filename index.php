                            ...
                            <div class="main-section" id="main_content">
                                                ...
                                                <div class="fbt_magazine-blog-post hentry fbt-index-post row align-items-center justify-content-between">
                                                    ...
                                                    <div class="col-xl-6 col-md-7">
                                                        <div class="fbt-post-caption mt-3 mt-md-0">
                                                            <span class="post-tag index-post-tag"><?=getCategory($db,$post['category_id'])?></span>
                                                            <h3 class="post-title">
                                                                <a href="post.php?id=<?=$post['id']?>">
                                                                    <?=$post['title']?>
                                                                </a>
                                ...
                                <div class="pagenav" id="blog-pager">
                                    ...
                                    <span class="showpage firstpage">
                                        <a href="?<?php if(isset($_GET['search'])){echo "search=$keyword&";} ?>page=<?=$previous-1?>">
                                            Previous
                                        </a>
                                    </span>
                                    <?php
                                    for($opage=1;$opage<=$total_pages;$opage++){
                                        ?>
                                            ...
                                            <a href="?<?php if(isset($_GET['search'])){echo "search=$keyword&";} ?>page=<?=$opage?>"><?=$opage?></a>
                                            </span>
                                        <?php
                                    }
                                    ...
                                    ?>
                                    <span class="displaypageNum">
                                        <a href="?<?php if(isset($_GET['search'])){echo "search=$keyword&";} ?>page=<?=$next+1?>">
                                            Next
                                        </a>
                                    </span>
...
<!-- sidebar code import here --><!-- sidebar code import here --><!-- sidebar code import here --><!-- sidebar code import here --><!-- sidebar code import here -->
        ...
        <!-- newsletter import here --><!-- newsletter import here --><!-- newsletter import here --><!-- newsletter import here --><!-- newsletter import here -->
        <?php
